...
const configSchema = z.object({
	...
	OBSERVABILITY_HEALTH_CHECKS_ENABLED: z.string(),
	OBSERVABILITY_HEALTH_CHECKS_INTERVAL: z.string(),
	OBSERVABILITY_HEALTH_CHECKS_TIMEOUT: z.string(),
	OBSERVABILITY_HEALTH_CHECKS_CHECKS: z.string(),
});
